...
class Signin extends StatefulWidget {
  const Signin({super.key, this.resumeCallerOnSuccess = false});
...
class _SigninState extends State<Signin> {
  ...
  void _submitLogin() {
    ...
    context.read<AuthBloc>().add(
      LoginEvent(email: _emailController.text.trim(), password: _pin),
    );
  }
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                disabledBackgroundColor: _dark.withValues(
                                  alpha: 0.5,
                                ),
                                elevation: 0,
